...
createDirs(currentpath +"/"+ "outdir/test/def-01")
createDirs(currentpath +"/"+ "outdir/test/def-02")
createDirs(currentpath +"/"+ "outdir/test/def-03")
createDirs(currentpath +"/"+ "outdir/test/good")
createDirs(currentpath +"/"+ "outdir/val/def-01")
createDirs(currentpath +"/"+ "outdir/val/def-02")
createDirs(currentpath +"/"+ "outdir/val/def-03")
createDirs(currentpath +"/"+ "outdir/val/good")
# once created dirs then crop images
